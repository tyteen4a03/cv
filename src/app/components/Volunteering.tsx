    ...
    <Section>
        ...
        <Experience>
            ...
            <ExperienceDetailsList>
                <li>
                    Plans, delivers and supports IT solutions (hardware, software, telephony, wired/wireless internet)
                    to help homeless guests escape homelessness at Crisis at Christmas
                </li>
                ...
                <li>Manages team of ~25 Level 2 IT Helpdesk Volunteers and a knowledge base</li>
            </ExperienceDetailsList>
        </Experience>
        <Experience>
            <ExperienceHeading>
